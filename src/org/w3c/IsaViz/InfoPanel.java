...
class InfoPanel extends JFrame implements ActionListener {
    ...
    InfoPanel(Editor app,String projectFile,int nbResources,int nbLiterals,int nbProperties){
	super();
	application=app;
	retrieveSystemInfo();
	...
	buildConstraints(constraints,0,13,2,1,100,10);
	gridBag.setConstraints(p3,constraints);
	cpane.add(p3);

// 	JLabel jenaLb=new JLabel("Jena Version");
// 	buildConstraints(constraints,0,14,1,1,50,10);
...
// 	buildConstraints(constraints,1,14,1,1,50,0);
